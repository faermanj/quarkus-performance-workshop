...
BEGIN
    BEGIN
        -- Obter o current_balance e o limit do cliente
        SELECT balance, limit INTO current_balance, limit_val FROM client_entity WHERE id = client_id_arg FOR UPDATE;
        ...
        -- -- Verificar se há current_balance suficiente para transações do kind débito
        -- IF type_arg = 0 THEN
        ...
        -- -- Atualizar o current_balance do cliente
        -- IF type_arg = 0 THEN
        --     current_balance := current_balance - amount_arg;
        -- ELSE
        --     current_balance := current_balance + amount_arg;
