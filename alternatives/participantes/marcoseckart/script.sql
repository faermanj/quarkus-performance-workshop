...
create table "transactions" ("id" serial not null primary key, "client_id" integer not null, "amount" integer not null, "kind" varchar(1) not null, "description" varchar(10) not null, "realizad_em" varchar(255) not null);
