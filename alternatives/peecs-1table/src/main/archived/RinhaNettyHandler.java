...
public class RinhaNettyHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        if (method.equals(HttpMethod.GET) && uri.startsWith("/clientes/") && uri.endsWith("/balance")) {
            // processExtrato
        } else if (method.equals(HttpMethod.POST) && uri.startsWith("/clientes/") && uri.endsWith("/transactions")) {
            // postTransacao
        } else {
